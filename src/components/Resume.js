...
const Resume = () => {
  ...
  return (
    <section
      className="min-h-screen flex flex-col items-center  justify-center bg-secondary dark:bg-secondary"
      id="resume"
    >
      ...
      >
        ...
        <a
          href="https://github.com/Typonote/MyResume"
      ...
      <p class="leading-relaxed text-base text-primary mx-4 text-md sm:text-xl mb-10">
        저의 능력과 함께 앞으로 하고자 하는 것들에 대한 내용을 담았습니다.
      </p>
            ...
            >
              <div class="flex flex-col">
                ...
                <input
                  ...
                  class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-200 font-semibold focus:border-indigo-500 focus:outline-none"
                />
              </div>
              ...
              <input
                type="submit"
                value="전송"
                class="md:w-32 bg-indigo-500 disabled:opacity-50 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300 cursor-pointer"
                disabled={
                  name !== "" && email !== "" && phone !== "" ? false : true
                }
              />
            </form>
          </div>
