...
const Header = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-primary dark:bg-primary"
      id="home"
    >
      <div className="flex flex-col md:flex-row-reverse items-center justify-between">
        ...
        <div className="text-primary text-center md:text-left">
          ...
          <Link to="stack" smooth={true}>
            <button className="bg-indigo-500 px-10 py-3 uppercase mt-10  text-white text-1xl font-bold rounded-lg animate-bounce">
              {dummy.header.btnText}
            </button>
          </Link>
        </div>
      </div>
